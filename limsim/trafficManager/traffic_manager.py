...
class TrafficManager:
    ...
    def __init__(self,
                 ...
                 config_file_path="{}/config.yaml".format(os.path.dirname(__file__))):
    ...
    def plan(self, T: float, roadgraph: RoadGraph,
        ...
        for vehicle_id, vehicle in vehicles.items():
            ...
            if vehicle.vtype == VehicleType.OUT_OF_AOI:
                continue
            if not vehicle.update_behaviour(roadgraph, KEY_INPUT):
                return {}
            KEY_INPUT = ""
        ...
        for vehicle_id, trajectory in result_paths.items():
            ...
            if len(output_trajectories[vehicle_id].states) > 0:
